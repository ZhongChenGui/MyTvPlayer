...
public class MyItemBridgeAdapter extends ItemBridgeAdapter {

    private static final String TAG = "MyItemBridgeAdapter";
    private int mCheckSelect = -1;

    public MyItemBridgeAdapter(ObjectAdapter adapter) {
        super(adapter, null);
    }

    public MyItemBridgeAdapter(ObjectAdapter adapter, int checkSelect) {
        super(adapter, null);
        this.mCheckSelect = checkSelect;
    }
